...
public class LoginPage extends Login_Repo {
    ...
    public void loginAs(String role) throws InterruptedException {
        ...
        }else if(appURL.contains("uat")){
            switch (role) {
                case "INTERNAL HR":
                case "SUPER ADMIN":
                    localHelper.sendKeys(loginEmail_txt, uatProp.getProperty("INTERNAL_HR_EMAIL"), driver);
                    localHelper.sendKeys(loginPwd_txt, prop.getProperty("LOGIN_PWD"), driver);
                    break;
                case "CLIENT HR":
                    localHelper.sendKeys(loginEmail_txt, uatProp.getProperty("CLIENT_HR"), driver);
                    localHelper.sendKeys(loginPwd_txt, prop.getProperty("LOGIN_PWD"), driver);
                    break;
                case "EMPLOYEE":
                    localHelper.sendKeys(loginEmail_txt, uatProp.getProperty("EMPLOYEE"), driver);
                    localHelper.sendKeys(loginPwd_txt, prop.getProperty("LOGIN_PWD"), driver);
                    break;
                case "EMPLOYEE_FOR_TIME_OFF":
                    localHelper.sendKeys(loginEmail_txt, uatProp.getProperty("EMPLOYEE_FOR_TIME_OFF"), driver);
                    localHelper.sendKeys(loginPwd_txt, prop.getProperty("LOGIN_PWD"), driver);
                    break;
                case "MANAGER_TIME_OFF":
                    localHelper.sendKeys(loginEmail_txt, uatProp.getProperty("MANAGER_TIME_OFF"), driver);
                    localHelper.sendKeys(loginPwd_txt, prop.getProperty("LOGIN_PWD"), driver);
                    break;
                case "MANAGER":
                    localHelper.sendKeys(loginEmail_txt, uatProp.getProperty("MANAGER_TIME_OFF"), driver);
                    ...
                    break;
                case "HR SERVICE":
                    localHelper.sendKeys(loginEmail_txt, uatProp.getProperty("HR_SERVICE"), driver);
                    localHelper.sendKeys(loginPwd_txt, uatProp.getProperty("HRSD_PASSWORD"), driver);
                    break;
                case "ManagerWSE":
                    localHelper.sendKeys(loginEmail_txt, uatProp.getProperty("ManagerWSE"), driver);
                    localHelper.sendKeys(loginPwd_txt, prop.getProperty("LOGIN_PWD"), driver);
                    break;
                case "Manager_For_New_WSE":
                    localHelper.sendKeys(loginEmail_txt, uatProp.getProperty("Manager_For_New_WSE"), driver);
                    localHelper.sendKeys(loginPwd_txt, prop.getProperty("LOGIN_PWD"), driver);
                    break;
                case "HR_ADMIN_WSE":
                    localHelper.sendKeys(loginEmail_txt, uatProp.getProperty("HR_ADMIN_WSE"), driver);
                    localHelper.sendKeys(loginPwd_txt, prop.getProperty("LOGIN_PWD"), driver);
                    break;
                case "ManagerWSE_For_New_WSE":
                    localHelper.sendKeys(loginEmail_txt, uatProp.getProperty("ManagerWSE_For_New_WSE"), driver);
                    localHelper.sendKeys(loginPwd_txt, prop.getProperty("LOGIN_PWD"), driver);
                    break;
                case "WSE_For_ManagerWSE":
                    localHelper.sendKeys(loginEmail_txt, uatProp.getProperty("WSE_For_ManagerWSE"), driver);
                    localHelper.sendKeys(loginPwd_txt, prop.getProperty("LOGIN_PWD"), driver);
                    break;
                case "WSE_Through_API":
                    localHelper.sendKeys(loginEmail_txt, uatProp.getProperty("WSE_Through_API"), driver);
                    localHelper.sendKeys(loginPwd_txt, prop.getProperty("LOGIN_PWD"), driver);
            }
        }
