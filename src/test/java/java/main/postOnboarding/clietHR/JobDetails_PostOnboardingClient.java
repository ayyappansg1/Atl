...
public class JobDetails_PostOnboardingClient extends BaseTest {
    ...
    public void setUp() throws InterruptedException, IOException, ParseException {
        ...
        jsonPathEvaluator = new Profile_PostOnboarding(driver).getResponse(baseURI,prop.getProperty("EMPLOYEE_ID_CLI")).jsonPath();
        new Profile_PostOnboarding(driver).clickJobDetailsStepper();
    }

    @Description("Verify the Active employee Job detail stepper - Client HR")
