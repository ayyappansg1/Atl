...
public class Profile_PostOnboardingInternal extends BaseTest {
    ...
    public void setUp() throws InterruptedException, IOException {
        ...
        jsonPathEvaluator = profile_postOnboarding.getResponse(baseURI,prop.getProperty("EMPLOYEE_ID")).jsonPath();
    }

    @Description("Verify the Active employee profile stepper")
